...
Route::get('/test-agreements', [AgreementController::class, 'index']); // List agreements
// Public routes
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/agreements', [AgreementController::class, 'store'])->middleware('role:Admin|Manager|Sale Operator'); // Create agreements
